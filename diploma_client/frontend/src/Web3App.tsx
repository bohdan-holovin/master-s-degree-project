...
init({
  ...
  appMetadata: {
    name: "Spring Boot Web3",
    icon: spring,
    description: "A Spring Boot Web3",
  },
});
...
export const Web3App: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-100">
      <div
        className="flex flex-col p-4 m-3 space-y-10 bg-white rounded-2xl md:flex-row md:space-y-0 md:space-x-10 md:m-0 md:p-16">
